...
export default {
  ...
  watch: {
    ...
    match(val){
      if(val.id != null){
        this.get_player_data(val.member1.registration_event.id, 'team1')
        this.get_player_data(val.member2.registration_event.id, 'team2')
      }
    },
  },
  created(){
        ...
        <div class="match-grid-1 d-flex align-items-center">
          <div>
            ...
            <p class="m-0 text-secondary">{{ match.tournament != null ? match.tournament.event_category_sport_category.name :
                match.group.event_category_sport_category.name }} / {{ match.tournament != null ?
  match.tournament.type.name : match.group.name }}</p>
          </div>
        </div>
        ...
        <div class="match-grid-4 d-flex align-items-center justify-content-center justify-content-md-start flex-column flex-md-row member-container">
          <div class="d-flex align-items-center justify-content-center match-image-container">
            <img :src="match.tournament != null ? match.tournament.registration_event1.url_image : match.member1.registration_event.url_image" />
          </div>
        ...
        <div class="match-grid-6 d-flex align-items-center justify-content-end flex-column-reverse flex-md-row member-container">
          ...
          <div class="d-flex align-items-center justify-content-center match-image-container">
            <img :src="match.tournament != null ? match.tournament.registration_event2.url_image : match.member2.registration_event.url_image" />
          </div>
        </div>
