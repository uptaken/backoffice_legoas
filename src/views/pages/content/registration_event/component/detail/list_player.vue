  ...
  methods: {
    ...
    onTopButtonClicked(index){
      ...
      if(top_button.id == 'download_excel')
        window.open(base.host + '/export/registration/player/excel?registration_event_id=' + this.$route.params.id, '_blank')
    },
    onLoadComplete(){
    ...
    <div class="card">
      <div class="card-body">
        <CustomTable
          ...
          :url="base.url_api + '/event/registration/player?registration_event_id=' + $route.params.id"
