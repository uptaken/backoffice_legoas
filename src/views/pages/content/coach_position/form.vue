...
export default {
    ...
    async mounted() {
        ...
        if (this.$route.params.id != null) {
          base.save_current_page('Edit Coach Position')
            this.is_view_only = true
            this.get_data()
        }
        else
          base.save_current_page('Add Coach Position')
    ...
    methods: {
      ...
      onCategorySportClicked(index){
        ...
        async get_data() {
            ...
            var url = base.url_api + '/coach-position?id=' + this.$route.params.id
            var response = await base.request(url);
