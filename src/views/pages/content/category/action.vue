...
import GeneralInfo from "@/views/pages/content/category/component/action/general_info";
import ListSubCategory from "@/views/pages/content/category/component/action/list_sub_category";
...
export default {
    ...
    return {
      ...
      arr_tabs: [
        ...
        },
        {
          ...
          icon: 'far fa-user',
          tab: 'List Sub Category',
          component: 'list-sub-category',
        },
      ],
      is_submit: false,
      first_time: true,
  ...
  async mounted() {
    base.save_current_page(this.$route.params.id != null ? 'Edit Category' : 'Add Category')
    this.title = this.$route.params.id != null ? 'Edit Category' : 'Add Category'
  ...
  methods: {
    async get_data() {
      ...
      var response = await base.request(base.url_api + '/category?id=' + this.$route.params.id)
      setTimeout(() => {
    ...
    async post_action(){
      this.is_submit = false
      $('#please_wait_modal').modal('show')
      var response = await base.request(base.url_api + '/category' + (this.$route.params.id != null ? '/edit' : ''), 'post', this.data);
