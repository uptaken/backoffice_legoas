...
export default {
    ...
    methods: {
        ...
        async table_action_btn(type, row) {
            ...
            console.log(row)
            if (type === 'edit') {
                window.location.href = '/info-lelang/berita-lelang/action/edit/' + row.item.ID
            }
            else if (type === 'delete') {
                var flag_delete = 1
                ...
                if (response.status == "success") {
                    ...
                    for (var x in response_data) {
                        arr.push({
                            ...
                            'Publish Date': (response_data[x].publish_at != null ? moment(response_data[x].publish_at).format('DD MMM YYYY') : '-'),
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-sm-12 col-md-6">
                                <div class="text-md-right">
                                    <a href="/info-lelang/berita-lelang/action/add" class="btn btn-sm btn-primary">Add
                                        Berita</a>
                                </div>
                            </div>
                        </div>
