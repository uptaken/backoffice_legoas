 ...
 */
  export default {
    ...
    methods: {
      async get_data() {
        var url = base.url_api + '/news?id=' + this.$route.params.id
        ...
        if (response != null) {
          if (response.status == "success") {
            ...
            if (response_data != null) {
              ...
              this.image_data = {
                image_display: base.url_photo('news', response_data.file_name),
                data_image: ''
              }
            }
            else {
        ...
        if (type === 'edit') {
          if (this.is_view_only) {
            ...
            // else {
              ...
              }, 'redirect', '/info-lelang/berita-lelang')
              // response = await base.request(url, method, data);

              // if (response != null) {
              //   if (response.status == "success") {
              //     window.location.href = '/info-lelang/berita-lelang'
              //   }
              // }
            // }
          ...
          if (flag_delete) {
            ...
            if (response != null) {
              if (response.status == "success") {
                window.location.replace('/info-lelang/berita-lelang')
              }
            }
          }
        }
