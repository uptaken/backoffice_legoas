...
// import CKEditor from 'ckeditor4-vue'
  ...
  export default {
    ...
    async created() {
      ...
      base.save_current_page('Image Home Level 3', true)
      this.get_data()
    },
    methods: {
      async get_data() {
        $('#please_wait_modal').modal('show')
        var url = base.url_api + '/info/home/banner-level3'
      ...
      async onSubmit() {
        if(this.image_data.data_image == '')
          ...
          if (this.image_data.data_image !== '')
            form.image_banner_home_level3 = this.image_data.data_image
    ...
    <div class="row">
      ...
      <div class="col-12">
        <div class="form-group" v-for="(lang, index) in base.arr_lang_manual" :key="index">
          ...
          <input type="text" class="form-control" v-model="form['title_' + lang]" />
        </div>
      </div>
      ...
      <div class="col-12">
        <div class="form-group" v-for="(lang, index) in base.arr_lang_manual" :key="index">
          ...
          <input type="text" class="form-control" v-model="form['subtitle_' + lang]" />
        </div>
      </div>
