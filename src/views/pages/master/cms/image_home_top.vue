...
// import CKEditor from 'ckeditor4-vue'
  ...
  export default {
    ...
    async created() {
      ...
      base.save_current_page('Image Home Top', true)
      this.get_data()
    },
    methods: {
      async get_data() {
        $('#please_wait_modal').modal('show')
        var url = base.url_api + '/info/home/banner-top'
      ...
      async onSubmit() {
        if(this.image_data.data_image == '')
          ...
          if (this.image_data.data_image !== '')
            form.image_banner_home_top = this.image_data.data_image
